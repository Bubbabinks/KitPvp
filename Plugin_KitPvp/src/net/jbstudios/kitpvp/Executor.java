		...
		if (sender instanceof Player) {
			...
			if (args[0].equalsIgnoreCase("create")) {
				...
				if (Manager.editPlayers.contains(player)) {
					player.sendMessage(ChatColor.BLUE+"You have "+ChatColor.RED+"disabled"+ChatColor.BLUE+" your edit!");
					Manager.editPlayers.remove(player);
				}else {
					player.sendMessage(ChatColor.BLUE+"You have "+ChatColor.GREEN+"enabled"+ChatColor.BLUE+" your edit!");
					Manager.editPlayers.add(player);
				}
			}else {
